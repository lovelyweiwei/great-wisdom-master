...
export async function doPostFavourUsingPOST(
  ...
  return request<API.BaseResponseInt_>('/bi/post_favour/', {
    method: 'POST',
    headers: {
...
export async function listFavourPostByPageUsingPOST(
  ...
  return request<API.BaseResponsePagePostVO_>('/bi/post_favour/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyFavourPostByPageUsingPOST(
  ...
  return request<API.BaseResponsePagePostVO_>('/bi/post_favour/my/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
