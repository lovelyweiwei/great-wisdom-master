...
import {genChartByAiAsyncMqUsingPOST, genChartByAiAsyncUsingPOST} from '@/services/great-wisdom/chartController';
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      if (!res.data) {
        ...
        message.success('分析任务提交成功，稍后请在我的【我的图表】页面查看');
        form.resetFields();
      }
    } catch (e: any) {
